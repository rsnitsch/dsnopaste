...
class dsBericht {
    ...
    function __construct($units, $spied_resources=array('wood', 'loam', 'iron'), $lng='de')
    {
        ...
        $this->all_patterns = array('de' => array(  'troops_pattern' => '/(?:Anzahl|Verluste):\s+((?:[0-9]+\s+)+)/',
                                                    'spied_troops_pattern' => '/Einheiten au.{1,3}erhalb:\s+((?:[0-9]+\s*)+)/',
                                                    ...
                                                    'luck' => '/Gl.{1,3}ck \(aus Sicht des Angreifers\).*\s+([\-0-9]*[0-9]+\.[0-9]+)%/s',
                                                    'moral' => '/Moral:\s+([0-9]+)/',
                                                    ...
                                                    'wall' => '/Schaden durch (Rammen|Rammb.{1,3}cke):\s+Wall besch.{1,3}digt von Level ([0-9]+) auf Level ([0-9]+)/',
                                                    'catapult' => '/Schaden durch Katapultbeschuss:\s+([A-Za-zäöü]+) besch.{1,3}digt von Level ([0-9]+) auf Level ([0-9]+)/',
                                                    'espionage' => '/Spionage/',
                                                    'spied_resources_start' => '/Ersp.{1,3}hte Rohstoffe:\s+',
                                                    'buildings' => '/Geb.{1,3}ude/',
                                                    'b_main' => '/Hauptgeb.{1,3}ude\s+([0-9]+)/',
                                                    'b_barracks' => '/Kaserne\s+([0-9]+)/',
                                                    'b_stable' => '/Stall\s+([0-9]+)/',
                                                    'b_garage' => '/Werkstatt\s+([0-9]+)/',
                                                    'b_snob' => '/Adelshof\s+([0-9]+)/',
                                                    'b_smith' => '/Schmiede\s+([0-9]+)/',
                                                    ...
                                                    'b_storage' => '/Speicher\s+([0-9]+)/',
                                                    'b_hide' => '/Versteck\s+([0-9]+)/',
                                                    'b_wall' => '/Wall\s+([0-9]+)/',
