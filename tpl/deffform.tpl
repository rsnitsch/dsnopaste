			...
			<tr>
				...
				<td>
					<table border="0">
						...
						<tr>
							<td>Speerträger Stufe:</td>

							<td><input type="text" name="verteidiger_speer_stufe" /></td>
						</tr>
						<tr>
							<td>Schwertträger Stufe:</td>
							<td><input type="text" name="verteidiger_schwert_stufe" /></td>
						</tr>
						<tr>
							<td>Schwere K. Stufe:</td>

							<td><input type="text" name="verteidiger_skav_stufe" /></td>
						</tr>
					</table>
				</td>
			</tr>
